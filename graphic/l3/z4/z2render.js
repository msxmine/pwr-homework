...
//Shadery do segmentacji miedzy wykresami
pixelVertSrc = `
...
pixelFragSrc = `
void main(void) {
    mediump float d = floor( mod( gl_FragCoord.x + gl_FragCoord.y, 2.0) ); //Szachownica
    //mediump float d = floor( mod( gl_FragCoord.x, 2.0) ); //Pionowe linie
    //mediump float d = floor( mod( gl_FragCoord.y, 2.0) ); //Pozome linie
    if (d > 0.5 ) {
        discard;
    }
...
//Maska ekranu do generowania szablonu
...
gl.clearDepth(1.0);
//Domyslnie ustaw szablon na 0
gl.clearStencil(0);

//Daj GL informacje o oknie
gl.viewport(0.0, 0.0, canvas.width, canvas.height);

//Wygeneruj filtr segmentacji w buferze szablonowym
...
var draw = function(time){
    ...
    var cl3 = [0,1,1,1] //Kolor powierzchni RGBA
    var cl4 = [1,0,1,1] //Kolor punktow RGBA
