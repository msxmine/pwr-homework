...
void main(void) {
 ...
 //Pozycja wzgledem obserwatora
 vScreenPosition = vec3(uProjectionMatrix * uViewMatrix * vec4(aVertexPosition, 1.));
 gl_PointSize = 1.0;
}
`;
...
varying mediump vec3 vScreenPosition;
void main(void) {
 ...
 //Mgla z zadania 3
 mediump vec4 mask = vec4(1.0,1.0,1.0, 1.8-(vScreenPosition.z/2.0) );
 gl_FragColor = final*color*mask;
}`;
