...
var draw = function(time){
    ...
    var cl = [0.5,0.5,0.5,1] //Kolor powierzchni RGBA
    var cl2 = [1,1,1,1] //Kolor punktow RGBA
    var lpos = [0,5,0] //Pozycja swiatla XYZ
    var lcolor = [1,1,1] //Kolor swiatla RGB

    //Widok z oka lewego i prawego
    vmat_left = [...vmat]
    vmat_left[12] += 0.01; //dla lewego oka przesun obiekt w prawo
    vmat_right = [...vmat]
    vmat_right[12] -= 0.01;
    ...
    //Podepnij indeksy
    gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, surf_buf)
    //Ustaw widok i filtr kolorow dla lewego oka
    gl.uniformMatrix4fv(_Vmatrix, false, vmat_left);
    ...
    //Wyczysc bufor glebokosci do ponownego rysowania
    gl.clear(gl.DEPTH_BUFFER_BIT);
    //Ustaw widok i filtr kolorow dla prawego oka
    gl.uniformMatrix4fv(_Vmatrix, false, vmat_right);
