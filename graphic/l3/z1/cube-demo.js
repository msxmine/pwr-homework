...
window.onload= async function(){
    ...
    //Pliki tekstur
    texture_files = ["bricks.png", "pepper.png", "checker.png", "c13.png", "alice.png", "pwr.png"]
    tekture_sky_files = ["iron_block.png", "bricks.png", "iron_block.png", "bricks.png", "iron_block.png", "bricks.png"]

    for(var skyboxStep=0; skyboxStep<6; skyboxStep++ ){
    //Funkcj tworzace i ladujace tekstury
    await my_loadTexture(gl, sbx_textureId, gl.TEXTURE_CUBE_MAP, cubeFace[skyboxStep], tekture_sky_files[skyboxStep])
	boxFaceTextures.push( my_createTexture(gl, gl.TEXTURE_2D, "cube_face_" + skyboxStep + " (" + texture_files[skyboxStep] + ")") );
    await my_loadTexture(gl, boxFaceTextures[boxFaceTextures.length-1], gl.TEXTURE_2D, gl.TEXTURE_2D, texture_files[skyboxStep])
    }
